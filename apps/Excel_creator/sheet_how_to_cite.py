...
def add_citation_sheet(workbook):
    ...
    lines = [
        ...
        "",
        "If you use code or Voila notebooks for scientific analysis from the nomad-hzb repository, please cite as follows (unless the journal that you wish to publish requires a different format):",  # noqa: E501
        "",
        "Citation Fields:",
        ...
        "Version or Date Downloaded: [Version, release tag, or date you accessed/downloaded the code]",  # noqa: E501
        "• (Optional) Commit Hash: [Specific commit hash, for reproducibility]",
        "• License: Code: Apache-2.0; Voila Notebooks: CC BY 4.0",
        "",
        "Example Citation:",
        "NOMAD Hysprint: NOMAD's schema for HZB perovskite research. NOMAD-HZB contributors. 2025. GitHub. https://github.com/nomad-hzb/nomad-hysprint. Accessed: 2025-04-25. Version: main branch, commit [commit-hash]. Code licensed under Apache-2.0; Voila notebooks licensed under CC BY 4.0.",  # noqa: E501
    ]
