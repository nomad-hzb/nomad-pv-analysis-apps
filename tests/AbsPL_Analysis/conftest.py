...
_APP_DIR = Path(__file__).parent.parent.parent / "apps" / "AbsPL_Analysis"
...
_spec = importlib.util.spec_from_file_location("dm_abspl", _APP_DIR / "data_manager.py")
_dm = importlib.util.module_from_spec(_spec)
sys.modules["dm_abspl"] = _dm
sys.modules["data_manager"] = _dm
_spec.loader.exec_module(_dm)

from data_manager import AbsPlDataManager  # noqa: E402
...
@pytest.fixture
def loaded_manager():
    """AbsPlDataManager populated via load_offline() from the JSON fixture."""
